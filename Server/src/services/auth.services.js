...
export const createUser = async (userData) => {
  ...
  if (
    ...
    throw createHttpError.BadRequest(
      "Plase make sure your name is between 2 and 25 characters."
    );
  }
  ...
  if (status && status.length > 100) {
    throw createHttpError.BadRequest(
      "Please make sure your status is less than 100 characters."
    );
  }
  ...
  if (checkDb) {
    throw createHttpError.Conflict(
      "Please try again with another email address, this email already exist."
    );
  }
