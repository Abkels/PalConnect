...
export const Picture = ({readablePicture,setReadablePicture, setPicture}) => {
    ...
    const handlePicture=(e)=> {
        ...
        if(
            ...
            setError(`${pic.name} is too large, maximum of 5mb allowed.`) //test for 5mb
            return;
        }else{
            setError("");
            setPicture(pic);
    ...
    const handleChangePic = ()=>{
        setPicture("");
        setReadablePicture("");
        // inputRef.current.click(); // allows you to click and change the pic..Remove is a better option
    }
  return (
